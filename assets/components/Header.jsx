          ...
          >
            <Box sx={style}>
              <Typography id="modal-modal-title" className="flex">
                <p className="font-['Montserrat'] text-2xl font-extrabold mr-4">Damien Dupont</p>
                <p className="font-['Montserrat'] text-base mt-2">Web developper</p>
              </Typography>
              <Typography id="modal-modal-description" sx={{ mt: 1 }}>
                <div className="text-[#e79759] text-2xl font-bold mt-6">Be the first to know about upcoming missions :</div>
                <div className="flex flex-col ml-20 mt-8 text-left">
                  <div><Checkbox {...label} defaultChecked />By Email : DamienDupont.dev@gmail.com</div>
                  <div><Checkbox {...label} />By mobile : 06 65 85 92 01</div>
                  <p className="text-xs italic ml-10 -mt-2">One SMS will be sent to you per week</p>
                </div>
              </Typography>
            </Box>
          </Modal>
